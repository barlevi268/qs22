...
class UsersRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/:id(\\d+)`, authAdminMiddleware, this.usersController.getUserById);
    ...
    this.router.delete(`${this.path}/:id(\\d+)`, authAdminMiddleware, this.usersController.deleteUser);
  }
}
